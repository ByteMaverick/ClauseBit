...
const ClauseBitDashboard: React.FC = () => {
  ...
  return (
      <>
        {/* Desktop layout */}
        <div
            className="hidden lg:flex h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 flex-col lg:flex-row">
          <Sidebar
              isOpen={sidebarOpen}
        ...
        <div
            className="lg:hidden h-screen flex items-center justify-center bg-gradient-to-br from-purple-200 via-white to-purple-200 px-6 text-center">
          <div className="max-w-md">
            <h1 className="text-2xl font-semibold text-purple-700 mb-4">
              ClauseBit is only available on desktop.
            </h1>
            <p className="text-gray-700 text-base">
              For the best experience, please visit this app on a larger screen (tablet or desktop).
